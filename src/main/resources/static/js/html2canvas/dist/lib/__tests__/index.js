...
describe('html2canvas', function () {
    ...
    it('should render with an element', function () {
    ...
    it('should have transparent background with backgroundColor: null', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, index_1.default(element, {backgroundColor: null})];
                    case 1:
                        _a.sent();
    ...
    it('should use existing canvas when given as option', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var canvas;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    it('should not remove cloned window when removeContainer: false', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
