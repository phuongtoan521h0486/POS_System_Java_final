        ...
        declaration.content.forEach(function (token) {
            if (token.type === 0 /* STRING_TOKEN */) {
                ...
                if (token.name === 'attr') {
                    ...
                    var _a = token.values.filter(parser_1.nonFunctionArgSeparator), counter = _a[0],
                        counterStyle = _a[1];
                    ...
                    var _b = token.values.filter(parser_1.nonFunctionArgSeparator), counter = _b[0], delim = _b[1],
                        counterStyle = _b[2];
                    if (counter && parser_1.isIdentToken(counter)) {
                        ...
                        var text = counterStates
                            .map(function (value) {
                                return counter_1.createCounterText(value, counterType_1, false);
                            })
                            .join(separator);
